...
melody for Melodia to track) is dropped, in both training and inference. Flags ~4.2% of corpus
windows as junk. Retrained + refit calibration:

| model | frozen top1 | frozen top3 |
|-------|-------------|-------------|
| windowed TDMS (was live) | 0.798 | 0.938 |
| **+ junk gate (now live)** | **0.806** | **0.946** |
