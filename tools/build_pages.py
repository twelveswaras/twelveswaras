...
<style>
  ...
  *{box-sizing:border-box}
  ...
  .lg-nyasa{background:transparent;border:2px solid var(--amber-hi)}
  ...
  .hear dt{font-family:var(--mono);font-size:.7rem;letter-spacing:.14em;text-transform:uppercase;color:var(--amber);margin:0 0 5px}
...
(function () {
  ...
  for (var i=0;i<12;i++){
    ...
    if (ny) g.appendChild(el('circle',{cx:p[0],cy:p[1],r:9,fill:'none',stroke:'#fbbf24','stroke-width':2}));
